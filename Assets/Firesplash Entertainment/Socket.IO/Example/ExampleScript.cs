...
public class ExampleScript : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        sioCom.Instance.On("WhosThere", (string payload) =>
        {
            ...
            if (payload == null) Debug.Log("RECEIVED a WhosThere event without payload data just as expected.");
        });

        //As the server asked for who we are, let's be polite and answer him.
